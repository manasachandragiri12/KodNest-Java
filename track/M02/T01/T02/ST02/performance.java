...
public class performance {
    ...
    public static void main(String[] args) {
        ...
        double returnedPercentage = utility.calculatePercentage(javaScore, sqlScore);

        double passingPercentage = utility.getPassingPercentage();

        System.out.println("Percentage: " + returnedPercentage);

        if (returnedPercentage >= passingPercentage) {
